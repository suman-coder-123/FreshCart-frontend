    ...
    <>
            <div className='flex flex-col md:flex-row justify-between items-center px-20 py-3 font-medium text-[#21313c] shadow-[0_2px_4px_rgba(0,0,0,0.18)]'>
              ...
              <div className='flex items-center gap-1 text-sm md:text-base '>
                   ...
                   <Link to="/registration" className='text-[#0aad0a] hover:underline'>Sign up </Link>
              </div>  
            </div>
            ...
            <div className='flex items-center justify-center mt-10 mb-20  xl:mt-2 bg-white'>
                  ...
                  <img src={Signin} alt="image" className='w-2/4 lg:w-1/2 xl:w-full img-fluid' />
              </div>
              <div className='w-full md:w-1/2 px-4 sm:px-6 md:px-10 lg:px-22 mt-8 md:mt-0'>
                      <h2 className='text-xl sm:text-3xl lg:text-4xl  font-bold text-[#21313c] mb-1 sm:mb-2 '>Sign in to FreshCart</h2>
                  ...
                  <form onSubmit={handleSubmit} action="" className="space-y-4">
                      ...
                      <div className='flex justify-between items-center fold-medium text-grey-600 '>
                        ...
                        <p className='text-gray-600  text-sm sm:text-base'>Remember me </p>
                        </div>
                        <p className='text-gray-600  text-sm sm:text-base'>Forgot Password ? <span><Link to="/reset" className='text-[#0aad0a]  text-sm sm:text-base'> Reset it </Link></span></p>
                      </div>
                      <button type='submit' className='w-full py-3 bg-[#0aad0a]  text-white rounded-lg hover:bg-green-700 transition border-gray-400'>Sign In</button>
                      <p className='text-gray-600  text-sm sm:text-base'>Don’t have an account? <span><Link to="/registration" className='text-[#0aad0a]  text-sm sm:text-base'>Sign up</Link></span></p>
                  </form>
              </div>
