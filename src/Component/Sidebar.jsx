      ...
      <div className="w-60 border-dashed border-r border-gray-300">
        ...
        <div className="px-4 py-3">
          ...
          <div>
            <Link
              to="product"
              className="flex items-center space-x-4 px-5 py-2 my-3  w-full text-[#5c6c75] font-medium  hover:bg-gray-100 border-gray-200 rounded-xl transition "
            >
          ...
          <div>
            <Link
              to="customer"
              className="flex items-center space-x-4 px-5 py-2 my-3 text-[#5c6c75] font-medium  hover:bg-gray-100 border-gray-200 rounded-xl transition "
            >
              <IoPeopleOutline />
              <p>Customers</p>
            </Link>
