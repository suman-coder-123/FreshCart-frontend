...
const Header = () => {
  return (
    <>
      <div>
        <p className="bg-[#f0f2f3] text-[#5c6c75] font-medium p-1 pl-20">
      ...
      <div className="flex justify-between items-center px-20 py-7">
        ...
        <div className="flex items-center gap-2 w-full max-w-xl">
          ...
          <button
            className=" hidden lg:flex items-center gap-1 border rounded-lg px-4 py-2 text-gray-400 border-gray-400
 font-medium hover:bg-gray-100 cursor-pointer"
          >
            <GrLocation className="text-gray-800 text-lg " /> Location
          </button>
        </div>
      ...
      <div className="  hidden lg:flex px-20 items-center gap-6  ">
        ...
        <div className="flex items-center gap-1">
                    <div className="relative group flex items-center gap-1 cursor-pointer">
            <label className="pb-1 font-medium text-gray-800">Shop</label>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4 mt-1 text-gray-500"
              fill="none"
        ...
        <div className="flex items-center gap-1">
          <div className="relative group flex items-center gap-1 cursor-pointer">
            <label className="pb-1 font-medium text-gray-800">Stores</label>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4 mt-1 text-gray-500"
              fill="none"
        ...
        <div className=" fixed max-w-lg inset-0 bg-white z-50 overflow-y-auto shadow-lg lg:hidden ">
          <div className="flex justify-between itmes-center px-3 my-5 lg:hidden ">
            ...
            <button onClick={() => setOpen(false)}>
              <RxCross2 className="text-grey-700 w-5 h-5" />
            </button>
          </div>
          ...
          <div className=" px-5 my-7  items-center gap-6  lg:hidden ">
            <div className=" flex justify-between items-center pb-2 gap-1 font-medium">
              <label htmlFor="home" className="pb-1 text-[#5c6c75]">
                Home
              </label>
            ...
            <div className="flex justify-between  items-center  pb-2 gap-1 font-medium">
              <label htmlFor="shop" className="pb-1 text-[#5c6c75]">
                Shop
              </label>
            ...
            <div className="flex justify-between  items-center pb-2 gap-1 font-medium">
              <label htmlFor="stores" className="pb-1 text-[#5c6c75]">
                Stores
              </label>
            ...
            <div className="flex justify-between  items-center pb-2 gap-1 font-medium">
              <label htmlFor="menu" className="pb-1 text-[#5c6c75]">
                Mega Menu
              </label>
            ...
            <div className="flex justify-between  items-center pb-2 gap-1 font-medium">
              <label htmlFor="pages" className="pb-1 text-[#5c6c75]">
                Pages
              </label>
            ...
            <div className="flex justify-between  items-center pb-2 gap-1 font-medium">
              <label htmlFor="account" className="pb-1 text-[#5c6c75]">
                Account
              </label>
            ...
            <p className=" text-[#5c6c75] pb-2 font-medium">Docs</p>
          </div>
        </div>
      )}
    </>
